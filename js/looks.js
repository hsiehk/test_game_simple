  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction: "Smile and find the small ridge that puffs up right under your lower lashes. Pat a light shimmer along the outlined band on top of it with your fingertip — this is the step that makes the eye look rounder rather than just lined.",
        tip: "Only highlight the part that actually rises when you smile; going lower reads as under-eye bags.",
      },
      {
        layer: "underEyeShade",
        title: "Shade just beneath",
        instruction: "Draw the faintest cool taupe line along the lower outlined curve, right under the ridge, then blend it until it is barely there. The shadow is what gives the highlight its roundness.",
        tip: "Cool taupe, never warm brown — warm tones here read as a dark circle.",
      },
      {
        layer: "lashes",
        title: "Curl and coat the lashes",
        instruction: "Clamp the curler at the roots for a few seconds, then walk it out to the tips. Coat from the base upward, wiggling into the roots, and concentrate the outer third so the eye pulls outward like the fan shown on your face.",
        tip: "If you want more than mascara gives, a half-strip of falsies on the outer corner only is far easier to place than a full strip.",
      },
      {
        layer: "blush",
